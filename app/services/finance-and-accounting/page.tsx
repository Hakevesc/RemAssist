...
export default function Page() {
  ...
  <section style={{ background: "linear-gradient(180deg,#f7faff 0%,var(--bg-marketing-paper) 62%)", borderBottom: "1px solid var(--border-default)" }}>
      <div className='fn-wrap fn-hero'>
  
        <div>
          <span className='fn-kicker'>Finance &amp; Accounting</span>
          <h1 className='fn-h1'>Books that close<br /><span>on time, every time.</span></h1>
          <p className='fn-lede'>Bookkeepers, accounts payable and receivable clerks, and payroll specialists
            working inside your ledger. Reconciled daily, closed monthly, every entry carrying its
            support.</p>
  
          <ul className='fn-checks'>
            <li><span className='fn-tick'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='m5 12.5 4.5 4.5L19 7' /></svg></span>
          ...
          <div className='fn-cta-row'>
            <a className='fn-btn hv-1' href='https://calendly.com/j-zemene-remassistance/new-meeting' target='_blank' rel='noopener'>
              Book a free consult
            ...
            <a className='fn-btn fn-btn--ghost hv-2' href='/qualify'>Qualify in two minutes</a>
          </div>
        ...
        <div className='fn-art'>
          <div className='fn-art-top'>
          ...
          <div className='fn-art-split'>
            <div className='fn-art-col'>
  ...
  <section className='fn-section' style={{ background: "var(--bg-marketing-paper)" }}>
      <div className='fn-wrap'>
        <span className='fn-kicker'>What you can staff</span>
        <h2 className='fn-h2' style={{ marginTop: "14px" }}>Six seats, <span>one finance desk.</span></h2>
        <p className='fn-lede'>Take one clerk on one process, or the whole desk. Every line below is a seat
          you can staff on its own.</p>
  
        <div className='fn-grid'>
          <div className='fn-card'>
            <span className='fn-card-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M3 10h18M6 6h12a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2Z' /><path d='M9 15h4' /></svg></span>
            ...
            <span className='fn-tag fn-tag--core'>Core</span>
          </div>
          <div className='fn-card'>
            <span className='fn-card-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M4 6h16v12H4z' /><path d='m4 7 8 6 8-6' /></svg></span>
          ...
          <div className='fn-card'>
            <span className='fn-card-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='m4 17 5-5 4 3 6-7' /><path d='M15 8h4v4' /></svg></span>
            <h3>Accounts receivable</h3>
            <p>Invoices raised on schedule, ageing worked to your escalation rules, every chase logged against the account.</p>
            <span className='fn-tag fn-tag--core'>Core</span>
          </div>
          <div className='fn-card'>
            <span className='fn-card-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><circle cx='12' cy='8' r='4' /><path d='M4 21v-1.5A5.5 5.5 0 0 1 9.5 14h5a5.5 5.5 0 0 1 5.5 5.5V21' /></svg></span>
            <h3>Payroll processing</h3>
            <p>Multi-state payroll runs, filings and employee records maintained, with the calendar owned rather than remembered.</p>
            <span className='fn-tag fn-tag--core'>Core</span>
          </div>
          <div className='fn-card'>
            <span className='fn-card-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M4 20V10M10 20V4M16 20v-7M22 20H2' /></svg></span>
            ...
            <span className='fn-tag'>Add-on</span>
          </div>
          <div className='fn-card'>
            <span className='fn-card-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M12 3 4 6.5V12c0 4.4 3.2 8 8 9 4.8-1 8-4.6 8-9V6.5z' /><path d='m8.7 12.2 2.3 2.3 4.4-4.7' /></svg></span>
            ...
            <span className='fn-tag'>Included</span>
          </div>
        </div>
      </div>
    </section>
  ...
  <section className='fn-band'>
      <div className='fn-wrap'>
        <span className='fn-kicker'>Cadence</span>
        <h2 className='fn-h2' style={{ marginTop: "14px" }}>Month-end should be a review, not an excavation.</h2>
        <p className='fn-lede'>That only holds if the work happens on a rhythm rather than in a panic. This
          is the rhythm every finance seat runs to.</p>
  
        <div className='fn-cadence'>
          <div className='fn-beat'>
            <em>Daily</em>
        ...
        <p className='fn-band-note'>Coverage drives the cost of a finance desk far more than seniority does.
  ...
  <section className='fn-section'>
      <div className='fn-wrap'>
        <span className='fn-kicker'>Control</span>
        <h2 className='fn-h2' style={{ marginTop: "14px" }}>You keep the signature. <span>We do the work behind it.</span></h2>
        ...
        <div className='fn-split'>
          ...
          <div className='fn-col fn-col--you'>
        ...
        <p className='fn-rule'><b>The rule we do not bend:</b> preparer and approver are different people,
  ...
  <section className='fn-section' style={{ background: "var(--bg-marketing-paper)" }}>
      <div className='fn-wrap'>
        <span className='fn-kicker'>Rates</span>
        <h2 className='fn-h2' style={{ marginTop: "14px" }}>Two tiers, <span>same controls.</span></h2>
        <p className='fn-lede'>Published, hourly, per seat — the same two tiers as every other service
          line. What differs here is the training, not the price.</p>
  
        <div className='fn-tiers'>
          <div className='fn-tier'>
            <div className='fn-tier-head'>
              <h3>Pro</h3>
              <span className='fn-tier-price'><small>from</small><b>$8</b><em>/hr</em></span>
            </div>
          ...
          <div className='fn-tier fn-tier--expert'>
            <div className='fn-tier-head'>
              <h3>Expert</h3>
              <span className='fn-tier-price'><small>from</small><b>$11</b><em>/hr</em></span>
            </div>
        ...
        <p className='fn-tier-note'>Coverage drives the cost far more than seniority does — see the
  ...
  <section className='fn-section'>
      <div className='fn-wrap'>
        <span className='fn-kicker'>Before you ask</span>
        <h2 className='fn-h2' style={{ marginTop: "14px" }}>The questions worth asking <span>before anyone near your ledger.</span></h2>
  ...
  <section className='fn-close'>
      <div className='fn-wrap'>
        ...
        <div className='fn-cta-row'>
          <a className='fn-btn hv-3' href='https://calendly.com/j-zemene-remassistance/new-meeting' target='_blank' rel='noopener'>
            Book a free consult
            <svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' aria-hidden='true'><path d='M5 12h14m-6-6 6 6-6 6' /></svg>
          </a>
          <a className='fn-btn fn-btn--ghost hv-4' href='/pricing'>See pricing</a>
        </div>
      </div>
    </section>
