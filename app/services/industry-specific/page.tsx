...
export default function Page() {
  ...
  <section style={{ background: "linear-gradient(180deg,#f7faff 0%,var(--bg-marketing-paper) 62%)", borderBottom: "1px solid var(--border-default)" }}>
      <div className='iv-wrap iv-hero'>
  
        <div>
          <span className='iv-kicker'>Industry-Specific</span>
          <h1 className='iv-h1'>Specialist desks,<br /><span>staffed by people who know the work.</span></h1>
          <p className='iv-lede'>Medical billing, insurance servicing, legal support and freight dispatch —
            four desks where a general assistant does not get far. Agents arrive knowing the forms, the
            systems and the exceptions.</p>
  
          <ul className='iv-checks'>
            <li><span className='iv-tick'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='m5 12.5 4.5 4.5L19 7' /></svg></span>
          ...
          <div className='iv-cta-row'>
            <a className='iv-btn hv-1' href='https://calendly.com/j-zemene-remassistance/new-meeting' target='_blank' rel='noopener'>
            ...
            <a className='iv-btn iv-btn--ghost hv-2' href='/qualify'>Qualify in two minutes</a>
          </div>
        ...
        <div className='iv-scope' aria-hidden='true'>
          ...
          <ul className='iv-bars'>
            <li className='iv-bar'>
              ...
              <div className='iv-track'><span className='iv-run'></span><span className='iv-own'></span></div>
              <p className='iv-line-label'><svg viewBox='0 0 24 24' aria-hidden='true'><rect x='5' y='11' width='14' height='9' rx='2' /><path d='M8.5 11V8a3.5 3.5 0 0 1 7 0v3' /></svg>
          ...
          <p className='iv-scope-foot'>The split shows scope, not a measurement. Where the line sits on your
  ...
  <section className='iv-section' style={{ background: "var(--bg-marketing-paper)" }}>
      <div className='iv-wrap'>
        <span className='iv-kicker'>Why a generalist stalls</span>
        <h2 className='iv-h2' style={{ marginTop: "14px" }}>These desks are made of words <span>you either know or you don't.</span></h2>
        <p className='iv-lede'>A capable assistant with no vertical training can follow a process until the first
          exception, then has to ask. On these desks the exceptions are most of the job.</p>
  
        <div className='iv-vocab'>
          <div className='iv-vgroup'>
            <b>Medical billing &amp; RCM</b>
  ...
  <section className='iv-section'>
      <div className='iv-wrap'>
        <span className='iv-kicker'>What you can staff</span>
        <h2 className='iv-h2' style={{ marginTop: "14px" }}>Four desks, <span>each with its own line.</span></h2>
        <p className='iv-lede'>Take one seat on the process that is currently backing up, or the whole desk. The
          boundary at the bottom of each panel is not fine print — it is the reason the rest is safe to
          hand over.</p>
  
        <div className='iv-desks'>
  
          <div className='iv-desk'>
            <div className='iv-desk-head'>
            ...
            <div className='iv-desk-sys'><span>Your PM / EHR</span><span>Your clearinghouse</span></div>
            <p className='iv-bound'><b>Where we stop</b>We do not select or sign off codes. Coding decisions
          ...
          <div className='iv-desk'>
            ...
            <div className='iv-desk-sys'><span>Your AMS</span><span>Carrier portals</span></div>
            <p className='iv-bound'><b>Where we stop</b>We do not bind coverage, quote to a client, or advise on
          ...
          <div className='iv-desk'>
            ...
            <div className='iv-desk-sys'><span>Your DMS</span><span>Your review platform</span></div>
            <p className='iv-bound'><b>Where we stop</b>We are not lawyers and give no legal advice. Judgment,
          ...
          <div className='iv-desk'>
            ...
            <div className='iv-desk-sys'><span>Your TMS</span><span>Load boards</span></div>
            <p className='iv-bound'><b>Where we stop</b>Rate authority and committing a load are yours. We
  ...
  <section className='iv-band'>
      <div className='iv-wrap'>
        <span className='iv-kicker'>How every desk runs</span>
        <h2 className='iv-h2' style={{ marginTop: "14px" }}>The same three rules, whichever desk it is.</h2>
        <p className='iv-lede'>Four different regulators, four different vocabularies, one operating model. These
          are the parts that do not change.</p>
  
        <div className='iv-rules'>
          <div className='iv-rule'>
            <span className='iv-rule-n'>01</span>
          ...
          <div className='iv-rule'>
            <span className='iv-rule-n'>02</span>
          ...
          <div className='iv-rule'>
            <span className='iv-rule-n'>03</span>
        ...
        <p className='iv-band-note'>We are an operations provider, not your compliance function and not your
        ...
        <a className='iv-inline-cta' href='https://calendly.com/j-zemene-remassistance/new-meeting' target='_blank' rel='noopener'>Scope your desk on a call
  ...
  <section className='iv-section' style={{ background: "var(--bg-marketing-paper)" }}>
      <div className='iv-wrap'>
        <span className='iv-kicker'>The hard questions</span>
        <h2 className='iv-h2' style={{ marginTop: "14px" }}>The questions worth asking <span>before a regulated desk changes hands.</span></h2>
  ...
  <section className='iv-close'>
      <div className='iv-wrap'>
        ...
        <div className='iv-cta-row'>
          <a className='iv-btn hv-3' href='https://calendly.com/j-zemene-remassistance/new-meeting' target='_blank' rel='noopener'>
            Talk through your desk
            <svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' aria-hidden='true'><path d='M5 12h14m-6-6 6 6-6 6' /></svg>
          </a>
          <a className='iv-btn iv-btn--ghost hv-4' href='/pricing'>See pricing</a>
        </div>
      </div>
    </section>
