...
export default function Page() {
  ...
  <div style={{ background: "var(--bg-marketing-paper)", borderBottom: "1px solid var(--border-default)" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "12px 24px" }}>
        <a href='/services/marketing-and-content' style={{ display: "inline-flex", alignItems: "center", gap: "7px", fontFamily: "var(--font-mono)", fontSize: "11px", letterSpacing: "0.08em", textTransform: "uppercase", fontWeight: 700, color: "var(--brand-blue)", textDecoration: "none" }} className='hv-1'>
  ...
  <section style={{ background: "var(--brand-navy)" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 24px 72px", display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: "64px", alignItems: "center" }}>
        <div>
          ...
          <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
            <a href='https://calendly.com/j-zemene-remassistance/new-meeting' target='_blank' rel='noopener' style={{ background: "var(--brand-blue)", color: "#fff", fontSize: "17px", fontWeight: 600, textDecoration: "none", padding: "14px 28px", borderRadius: "6px", transition: "background 150ms" }} className='hv-2'>Book a Call</a>
            <a href='/pricing' style={{ color: "#fff", fontSize: "17px", fontWeight: 600, textDecoration: "none", padding: "14px 20px", borderRadius: "6px", border: "1px solid var(--navy-500)" }} className='hv-3'>See pricing</a>
          </div>
        </div>
  ...
  <section style={{ background: "#fff", borderTop: "1px solid var(--border-default)", borderBottom: "1px solid var(--border-default)" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "64px 24px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "56px", alignItems: "center" }}>
        <div>
  ...
  <section id='book' style={{ background: "var(--brand-navy)" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 24px", textAlign: "center" }}>
        ...
        <a href='https://calendly.com/j-zemene-remassistance/new-meeting' target='_blank' rel='noopener' style={{ display: "inline-block", background: "var(--brand-blue)", color: "#fff", fontSize: "17px", fontWeight: 600, textDecoration: "none", padding: "15px 32px", borderRadius: "6px", transition: "background 150ms" }} className='hv-4'>Book a Call</a>
      </div>
    </section>
