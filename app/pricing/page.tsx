...
export default function Page() {
  ...
  <section style={{ background: "linear-gradient(180deg,#f7faff 0%,var(--bg-marketing-paper) 60%)" }}>
      <div className='pr-wrap pr-hero'>
        <span className='pr-kicker'>Pricing</span>
        <h1 className='pr-h1'>Two rates, <span>published.</span></h1>
        <p className='pr-lede'>Most of this industry makes you book a call to find out whether they are in
          your range. Here are the numbers. What we scope on the call is the shape, not the secret.</p>
  
        <div className='pr-chips'>
          <span className='pr-chip'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='m5 13 4 4L19 7' /></svg>Hourly, per seat</span>
          <span className='pr-chip'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='m5 13 4 4L19 7' /></svg>No setup fee</span>
          <span className='pr-chip'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='m5 13 4 4L19 7' /></svg>Add or drop seats any time</span>
          <span className='pr-chip'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='m5 13 4 4L19 7' /></svg>ISO 9001 &amp; 27001 audited</span>
        </div>
  
        <div className='pr-tiers'>
          <div className='pr-tier'>
            <span className='pr-tier-tag'>Best value</span>
            <h3>Pro</h3>
            <span className='pr-price'><small>from</small><b>$8</b><em>/hr</em></span>
          ...
          <div className='pr-tier pr-tier--expert'>
            <span className='pr-tier-tag'>Most judgment</span>
            <h3>Expert</h3>
            <span className='pr-price'><small>from</small><b>$11</b><em>/hr</em></span>
        ...
        <p className='pr-lede' style={{ marginTop: "26px", fontSize: "15px" }}>A pod can mix tiers — an Expert lead
  ...
  <section className='pr-section' style={{ background: "var(--bg-marketing-paper)" }}>
      <div className='pr-wrap'>
        <span className='pr-kicker'>Compare plans</span>
        <h2 className='pr-h2' style={{ marginTop: "14px" }}>Pick the shape, <span>then we scope it.</span></h2>
        <p className='pr-lede'>Every plan runs on the two published rates above. What changes is how the seats
        ...
        <div className='pr-plans'>
          <div className='pr-plan'>
            ...
            <span className='pr-plan-price'>From $8</span>
            <span className='pr-plan-unit'>Per agent per hour,<br />customized in consultation</span>
            <a className='pr-btn' href='mailto:support@remassistance.com'>Get started</a>
            <ul>
            ...
            <a className='pr-plan-more' href='/services/customer-service-agents'>Learn more →</a>
          </div>
  
          <div className='pr-plan pr-plan--featured'>
            <span className='pr-plan-tag'>Most popular</span>
            <h3>GTM Team</h3>
            <span className='pr-plan-price'>Custom</span>
            <span className='pr-plan-unit'>Per pod of 2–6 seats,<br />scoped to your motion</span>
            <a className='pr-btn' href='mailto:support@remassistance.com'>Get started</a>
            <ul>
            ...
            <a className='pr-plan-more' href='/services/gtm-teams'>Learn more →</a>
          </div>
  
          <div className='pr-plan'>
            <h3>SDR as a Service</h3>
            <span className='pr-plan-price'>From $8</span>
            <span className='pr-plan-unit'>Per SDR per hour,<br />customized in consultation</span>
            <a className='pr-btn' href='mailto:support@remassistance.com'>Get started</a>
            <ul>
            ...
            <a className='pr-plan-more' href='/services/sdr-as-a-service'>Learn more →</a>
          </div>
  
          <div className='pr-plan'>
            <h3>Extra Services</h3>
            <span className='pr-plan-price'>Custom</span>
            <span className='pr-plan-unit'>Per seat or per project,<br />mix into any plan</span>
            <a className='pr-btn' href='mailto:support@remassistance.com'>Get started</a>
            <ul>
            ...
            <a className='pr-plan-more' href='/services/extra-services'>Learn more →</a>
          </div>
        </div>
        <p className='pr-plans-note'>Figures are floors, not quotes — your exact rate depends on hours,
  ...
  <section className='pr-section' style={{ background: "#fff", borderTop: "1px solid var(--border-default)" }}>
      <div className='pr-wrap'>
        <span className='pr-kicker'>Read the small print</span>
        <h2 className='pr-h2' style={{ marginTop: "14px" }}>What the rate <span>does and does not</span> include.</h2>
  
        <div className='pr-two'>
          <div className='pr-list pr-list--in'>
          ...
          <div className='pr-list pr-list--out'>
  ...
  <section className='pr-band'>
      <div className='pr-wrap'>
        <span className='pr-kicker'>Before a full rollout</span>
        <h2 className='pr-h2' style={{ marginTop: "14px" }}>Start with a pilot, not a contract.</h2>
        <p className='pr-lede'>Training and security setup for your specific processes is real work, so we do
          not pretend it is free. What we do instead is keep the first phase small enough to measure.</p>
  
        <div className='pr-steps'>
          <div className='pr-step'>
            <span className='pr-step-n'>STEP 01</span>
          ...
          <div className='pr-step'>
            <span className='pr-step-n'>STEP 02</span>
          ...
          <div className='pr-step'>
            <span className='pr-step-n'>STEP 03</span>
  ...
  <section className='pr-section' style={{ background: "var(--bg-marketing-paper)" }}>
      <div className='pr-wrap'>
        <span className='pr-kicker'>Where your team sits</span>
        <h2 className='pr-h2' style={{ marginTop: "14px" }}>Two delivery centres, <span>three working setups.</span></h2>
        <p className='pr-lede'>Worth knowing before you compare rates: these are staffed offices, not a
          marketplace of freelancers bidding on your task.</p>
  
        <div className='pr-where'>
          <div className='pr-place'>
            <span className='pr-place-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M12 21s7-5.3 7-11a7 7 0 1 0-14 0c0 5.7 7 11 7 11z' /><circle cx='12' cy='10' r='2.6' /></svg></span>
          ...
          <div className='pr-place'>
            <span className='pr-place-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M4 20v-1.4A4.6 4.6 0 0 1 8.6 14h6.8a4.6 4.6 0 0 1 4.6 4.6V20' /><circle cx='12' cy='8' r='3.6' /></svg></span>
  ...
  <section className='pr-section' style={{ background: "#fff", borderTop: "1px solid var(--border-default)" }}>
      <div className='pr-wrap pr-narrow'>
        <span className='pr-kicker'>Before you ask</span>
        <h2 className='pr-h2' style={{ marginTop: "14px" }}>Pricing questions, <span>answered plainly.</span></h2>
  ...
  <section id='book' className='pr-close'>
      <div className='pr-wrap'>
        ...
        <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "13px", marginTop: "30px" }}>
          <a className='pr-btn' href='https://calendly.com/j-zemene-remassistance/new-meeting' target='_blank' rel='noopener'>
            Book a free consult
          ...
          <a className='pr-ghost-dark' href='/qualify'>Qualify in two minutes</a>
        </div>
      </div>
    </section>
