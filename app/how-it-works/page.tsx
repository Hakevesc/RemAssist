...
export default function Page() {
  ...
  <section style={{ background: "linear-gradient(180deg,#f7faff 0%,var(--bg-marketing-paper) 62%)", borderBottom: "1px solid var(--border-default)" }}>
      <div className='hw-wrap hw-hero'>
        <span className='hw-kicker'>How it works</span>
        <h1 className='hw-h1'>From first call to <span>a working pod.</span></h1>
        <p className='hw-lede'>Four phases, roughly two weeks, and you approve the people before they start.
          Here is the whole thing written down — including what we need from you, and what happens
          if it does not work out.</p>
  
        <div className='hw-chips'>
          <span className='hw-chip'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='m5 13 4 4L19 7' /></svg>Consultation is always free</span>
          <span className='hw-chip'><svg viewBox='0 0 24 24' aria-hidden='true'><circle cx='12' cy='12' r='9' /><path d='M12 7.5V12l3 2' /></svg>About two weeks to live</span>
          <span className='hw-chip'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='m5 13 4 4L19 7' /></svg>You interview and approve</span>
          <span className='hw-chip'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='m5 13 4 4L19 7' /></svg>Pilot before a full rollout</span>
        </div>
  
        <div className='hw-hero-cta'>
          <a className='hw-btn' href='https://calendly.com/j-zemene-remassistance/new-meeting' target='_blank' rel='noopener'>
            Book a free consult
          ...
          <a className='hw-btn hw-btn--ghost' href='/qualify'>Qualify in two minutes</a>
        </div>
      </div>
    </section>
  ...
  <section className='hw-section' style={{ background: "var(--bg-marketing-paper)" }}>
      <div className='hw-wrap'>
        <span className='hw-kicker'>The four phases</span>
        <h2 className='hw-h2' style={{ marginTop: "14px" }}>What actually happens, <span>and who does it.</span></h2>
        <p className='hw-lede'>Most of what goes wrong in outsourcing happens because nobody agreed who owns
          what. So each phase below says what we do, and what we need from you.</p>
  
        <ol className='hw-phases'>
          <li className='hw-phase'>
            <span className='hw-num'>01</span>
            <div className='hw-card'>
              <div className='hw-card-top'>
                <h3>Free consultation</h3>
                <span className='hw-when'>Day 1 · 30–45 min</span>
              </div>
          ...
          <li className='hw-phase'>
            ...
            <div className='hw-card'>
              <div className='hw-card-top'>
                <h3>Team design</h3>
                <span className='hw-when'>Days 2–3</span>
              </div>
          ...
          <li className='hw-phase'>
            ...
            <div className='hw-card'>
              <div className='hw-card-top'>
                ...
                <span className='hw-when'>Days 3–5</span>
              </div>
          ...
          <li className='hw-phase'>
            ...
            <div className='hw-card'>
              <div className='hw-card-top'>
                ...
                <span className='hw-when'>Week 2 onward</span>
              </div>
  ...
  <section className='hw-section' style={{ background: "#fff", borderTop: "1px solid var(--border-default)" }}>
      <div className='hw-wrap'>
        <span className='hw-kicker'>The usual shape of it</span>
        <h2 className='hw-h2' style={{ marginTop: "14px" }}>Two weeks, <span>laid out day by day.</span></h2>
        <p className='hw-lede'>Most clients go from first call to a fully onboarded pod inside two weeks. Where
        ...
        <div className='hw-weeks'>
          <div className='hw-week'>
            <div className='hw-week-label'><b>Week 1</b><span>Scope and select</span></div>
            <div className='hw-days'>
              <div className='hw-day hw-day--on'><em>Day 1</em><b>Free consult</b></div>
              <div className='hw-day hw-day--on'><em>Day 2</em><b>Pod designed</b></div>
              <div className='hw-day hw-day--on'><em>Day 3</em><b>Terms in writing</b></div>
              <div className='hw-day'><em>Day 4</em><b>Profiles sent</b></div>
              <div className='hw-day'><em>Day 5</em><b>You approve</b></div>
            </div>
          </div>
          <div className='hw-week'>
            <div className='hw-week-label'><b>Week 2</b><span>Train and go live</span></div>
            <div className='hw-days'>
              <div className='hw-day'><em>Day 6</em><b>Tool access</b></div>
              <div className='hw-day'><em>Day 7</em><b>Product training</b></div>
              <div className='hw-day'><em>Day 8</em><b>SOP written</b></div>
              <div className='hw-day hw-day--on'><em>Day 9</em><b>Supervised live work</b></div>
              <div className='hw-day hw-day--on'><em>Day 10</em><b>Reporting starts</b></div>
            </div>
          </div>
        </div>
        <p className='hw-weeks-note'>Working days, not calendar days, and a guide rather than a contract. The
  ...
  <section className='hw-band'>
      <div className='hw-wrap'>
        <span className='hw-kicker'>Once it is running</span>
        <h2 className='hw-h2' style={{ marginTop: "14px" }}>You should not have to ask how it is going.</h2>
        <p className='hw-lede'>Oversight is part of the rate, not an upsell. This is what arrives without you
          chasing anyone for it.</p>
  
        <div className='hw-grid3'>
          <div className='hw-bcard'>
            <span className='hw-bico'><svg viewBox='0 0 24 24' aria-hidden='true'><circle cx='12' cy='12' r='9' /><path d='M12 7.5V12l3 2' /></svg></span>
          ...
          <div className='hw-bcard'>
            <span className='hw-bico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M4 6h16v12H4z' /><path d='m4 7 8 6 8-6' /></svg></span>
          ...
          <div className='hw-bcard'>
            <span className='hw-bico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M12 3 4 6.5V12c0 4.4 3.2 8 8 9 4.8-1 8-4.6 8-9V6.5z' /><path d='m8.7 12.2 2.3 2.3 4.4-4.7' /></svg></span>
  ...
  <section className='hw-section' style={{ background: "var(--bg-marketing-paper)" }}>
      <div className='hw-wrap'>
        <span className='hw-kicker'>The uncomfortable question</span>
        <h2 className='hw-h2' style={{ marginTop: "14px" }}>And if it <span>does not work out?</span></h2>
        <p className='hw-lede'>Worth knowing before you start, not after. None of this is buried in a contract
          you have to ask for.</p>
  
        <div className='hw-safety'>
          <div className='hw-safe'>
            <span className='hw-safe-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M15.5 20.5v-1.8a3.7 3.7 0 0 0-3.7-3.7H6.2a3.7 3.7 0 0 0-3.7 3.7v1.8' /><circle cx='9' cy='7.2' r='3.7' /><path d='m17 8 2 2 3.5-3.5' /></svg></span>
          ...
          <div className='hw-safe'>
            <span className='hw-safe-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M4 12h16' /><path d='M4 7h10M4 17h10' /></svg></span>
          ...
          <div className='hw-safe'>
            <span className='hw-safe-ico'><svg viewBox='0 0 24 24' aria-hidden='true'><path d='M6 3h9l4 4v14H6z' /><path d='M15 3v4h4' /><path d='M9 12h7M9 16h5' /></svg></span>
  ...
  <section className='hw-section' style={{ background: "#fff", borderTop: "1px solid var(--border-default)" }}>
      <div className='hw-wrap hw-narrow'>
        <span className='hw-kicker'>Before you book</span>
        <h2 className='hw-h2' style={{ marginTop: "14px" }}>Questions about the process.</h2>
  ...
  <section className='hw-close'>
      <div className='hw-wrap'>
        ...
        <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: "13px", marginTop: "30px" }}>
          ...
          <a className='hw-ghost-dark' href='/pricing'>See pricing</a>
        </div>
      </div>
    </section>
